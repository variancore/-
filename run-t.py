...
def run_bot(data_account, recover=1):
    ...
    try:
        ...
        gmail = f"{random_string(6)}-android-{random_string(6)}@gmail.com"
        slug = f"{kw}-Mod premium"
        judul = f"!DOWNLOAD {kw} Premium APK Download Latest Version Free for Android"
        link = f"https://apps.freeplayer.one/?title= CLICK HERE >> APK?ref=04"
        ...
        try:
            konten = f'{kw} MOD PREMIUM Enjoy millions of the latest Android apps, games, music, movies, TV, books, magazines & more. Anytime, anywhere, across your devices \n'
            driver.find_element(
                By.XPATH,
